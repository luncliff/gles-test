...
TEST_ES=test_imx5_sphere
TEST_ES_RUN=(
	'-frames 100 -bitness "5 6 5 0" -app "tile 4"'
	'-frames 100 -bitness "5 6 5 0" -app "tile 4" -app "albedo_map foo 16 16"'
	'-frames 100 -bitness "8 8 8 0" -app "tile 4"'
	'-frames 100 -bitness "8 8 8 0" -app "tile 4" -app "albedo_map foo 16 16"'
)
TEST_ES_FPS=(
	16.20
	16.20
