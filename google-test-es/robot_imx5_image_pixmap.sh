...
TEST_ES=test_imx5_image_pixmap
TEST_ES_RUN=(
	'-frames 1000 -bitness "5 6 5 0" -screen "512 512 60" -app "image_dim 512 512"'
	'-frames 1000 -bitness "8 8 8 0" -screen "512 512 60" -app "image_dim 512 512"'
)
TEST_ES_FPS=(
	136.2
	108.5
