...
void main()
{
	...
	p_obj += (bone[index.y] * vec4(at_Vertex, 1.0)).xyz * weight.y;
	p_obj += (bone[index.z] * vec4(at_Vertex, 1.0)).xyz * weight.z;
	p_obj += (bone[index.w] * vec4(at_Vertex, 1.0)).xyz * weight.w;
