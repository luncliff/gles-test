...
TEST_ES=test_imx5_fill
TEST_ES_RUN=(
	'-frames 1000 -bitness "5 6 5 0" -drawcalls 4'
	'-frames 1000 -bitness "5 6 5 0" -drawcalls 16'
	'-frames 1000 -bitness "8 8 8 0" -drawcalls 4'
	'-frames 1000 -bitness "8 8 8 0" -drawcalls 16'
)
TEST_ES_FPS=(
	111.0
	30.0
